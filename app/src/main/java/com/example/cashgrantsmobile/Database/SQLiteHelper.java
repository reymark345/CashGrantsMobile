...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public void insertDatabase(String hh_id,String first_name,String last_name,String middle_name,String ext_name,String sex,String province,String municipality, String barangay, String set,
                ...
                try{
                    ...
                    nma_validations.bindString(7, nma_non_emv);
    ...
    public void updateDatabase(String hh_id,String first_name,String last_name,String middle_name,String ext_name,String sex,String province,String municipality, String barangay, String set,
        ...
        try{
            database.beginTransaction();
                ...
                deleteOtherCardValidations(ocv_id1,database);
                deleteOtherCardValidations(ocv_id2,database);
                deleteOtherCardValidations(ocv_id3,database);
                deleteOtherCardValidations(ocv_id4,database);
                deleteOtherCardValidations(ocv_id5,database);

                String sql_tmp_blob = "DELETE FROM tmp_blob WHERE id=2";
                SQLiteStatement statement_tmp_blob = database.compileStatement(sql_tmp_blob);
                statement_tmp_blob.clearBindings();
                statement_tmp_blob.execute();
                ...
                Log.v(TAG,"Error in database Update" + e);
        } finally {
            database.endTransaction();
            database.close();
        }
    ...
    public void deleteOtherCardValidations(int ocv_id, SQLiteDatabase database) {
            ...
            try {
                ...
                try {
                    ...
                    String sql = "INSERT INTO emv_validations (id,first_name, last_name, middle_name, ext_name, hh_id, hh_status, province, municipality, barangay, " +
                            ...
                            "upload_history_id,record_counter,ovt_paunawa_conformed,created_at, updated_at, validated_at,nma_non_emv,nma_card_name) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
                    ...
                    statement.bindString(39, extractedData.getString("ovt_paunawa_conformed"));
                    statement.bindString(40, extractedData.getString("created_at"));
                    statement.bindString(41, extractedData.getString("updated_at"));
                    statement.bindString(42, extractedData.getString("validated_at"));
                    statement.bindString(43, extractedData.getString("non_emv_card_number"));
                    statement.bindString(44, extractedData.getString("card_name"));
                    statement.executeInsert();
                }
                catch(Exception e){
                    Log.v(TAG,"Error "+e );
