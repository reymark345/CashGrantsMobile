...
public class MainActivity extends AppCompatActivity {
    ...
    public void createDatabase(){
        ...
        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS grantee_validations(id INTEGER PRIMARY KEY AUTOINCREMENT, hh_id INTEGER, first_name VARCHAR, last_name VARCHAR, middle_name VARCHAR, ext_name VARCHAR, sex VARCHAR, province VARCHAR, municipality VARCHAR, barangay VARCHAR, hh_set VARCHAR, created_at TIMESTAMP)");
