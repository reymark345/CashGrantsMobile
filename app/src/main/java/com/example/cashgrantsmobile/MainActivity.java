...
public class MainActivity extends AppCompatActivity {
    ...
    public void createDatabase(){
        ...
        sqLiteHelper.queryData("CREATE TABLE IF NOT EXISTS nma_validations(id INTEGER PRIMARY KEY AUTOINCREMENT, amount DECIMAL, date_claimed DATE, reason VARCHAR, remarks VARCHAR,created_at TIMESTAMP, nma_others_reason TEXT)");
